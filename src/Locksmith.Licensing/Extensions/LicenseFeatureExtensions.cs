...
namespace Locksmith.Licensing.Extensions;
...
public static class LicenseFeatureExtensions
{
    ...
    public static bool HasFeature(this LicenseDescriptor license, string feature)
    {
    ...
    public static bool HasAnyFeature(this LicenseDescriptor license, params string[] features)
    {
    ...
    public static bool HasAllFeatures(this LicenseDescriptor license, params string[] features)
    {
